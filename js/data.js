export const results = [
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "705 ₾", rawPrice: 705, direct: true },
        direct: { price: "705 ₾", rawPrice: 705, direct: true },
      },
      image: {
  ...
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "875 ₾", rawPrice: 875, direct: true },
        direct: { price: "875 ₾", rawPrice: 875, direct: true },
      },
      image: {
  ...
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "1,040 ₾", rawPrice: 1040, direct: true },
        direct: { price: "1,040 ₾", rawPrice: 1040, direct: true },
      },
      image: {
  ...
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "1,055 ₾", rawPrice: 1055, direct: false },
      },
      image: {
  ...
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "1,093 ₾", rawPrice: 1093, direct: true },
        direct: { price: "1,093 ₾", rawPrice: 1093, direct: true },
      },
      image: {
        url: "https://content.skyscnr.com/1e1ee1429a2277feae3d34a0cdf57886/GettyImages-135083549.jpg",
      },
      flightRoutes: { directFlightsAvailable: true },
    },
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "1,169 ₾", rawPrice: 1169, direct: false },
      },
      image: {
  ...
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "1,252 ₾", rawPrice: 1252, direct: false },
      },
      image: {
  ...
  },
  {
    ...
    content: {
      ...
      flightQuotes: {
        cheapest: { price: "1,268 ₾", rawPrice: 1268, direct: false },
      },
      image: {
